...
#######################################################################
#######################################################################
#K=11,16 FOR LINEAR MODEL
#K=11, 16 FOR QUADRATIC MODEL
best.l = numeric(0)
best.q = numeric(0)

best.2.l = as.numeric(na.omit(l.computeCVmse2(16)))
tail(best.2.l) #125.71310 140.31137 159.17063 206.87493 248.51657  49.87751
mean(best.2.l) #50.73407

best.q = as.numeric(na.omit(q.computeCVmse2(11)))
tail(best.q)
mean(best.q) #203.2458
best.2.q = as.numeric(na.omit(q.computeCVmse2(16)))
tail(best.2.q)
mean(best.2.q) #208.8651

#Best model linear trend with k=16.
